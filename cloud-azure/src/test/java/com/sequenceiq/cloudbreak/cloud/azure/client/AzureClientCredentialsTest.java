...
public class AzureClientCredentialsTest {
    ...
    @Test
    public void testGetKeyVaultManagerForSubscriptionId() {
        KeyVaultManager result = new AzureClientCredentials(credentialView, LOG_LEVEL,
                cbRefreshTokenClientProvider, authenticationContextProvider, tracingInterceptor).getKeyVaultManager();
        assertNotNull(result);
        assertEquals(SUBSCRIPTION_ID, result.subscriptionId());
    }
